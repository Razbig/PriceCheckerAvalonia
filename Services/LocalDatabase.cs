...
namespace PriceCheckerAvalonia.Services
{
    public class LocalDatabase
    {
        ...
        // Upsert stores from remote/master source
        public void UpsertStores(IEnumerable<PriceCheckerAvalonia.Model.Store> stores)
        {
            using var conn = OpenConnection();
            conn.Open();
        ...
        public List<PriceCheckerAvalonia.Model.Store> GetStores()
        {
            using var conn = OpenConnection();
            conn.Open();
            var rows = conn.Query<PriceCheckerAvalonia.Model.Store>(
